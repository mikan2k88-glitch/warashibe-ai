...
def run_cycle():
    modules = [
        ...
        "research_lab.test_identifier_conflict_resolution", "research_lab.test_conflict_aware_evidence_grouping", "research_lab.test_market_estimate_quality_gate", "research_lab.test_quality_gated_candidate_pipeline", "research_lab.test_end_to_end_market_decision_pipeline",
    ]
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "end_to_end_market_decision_pipeline", "next_theme": "multi_provider_market_snapshot", "checks": checks}
