...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "autonomous_research_orchestrator_execution_layer_executor_activation_design", "next_theme": "autonomous_research_orchestrator_execution_layer_executor_activation_policy", "checks": checks}
