...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "autonomous_research_controller_policy_bridge", "next_theme": "autonomous_research_controller_policy_enforcement", "checks": checks}
