...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "autonomous_research_snapshot_file_adapter", "next_theme": "autonomous_research_snapshot_freshness_gate", "checks": checks}
