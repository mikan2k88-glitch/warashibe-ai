...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "autonomous_research_fresh_snapshot_decision", "next_theme": "autonomous_research_safe_snapshot_controller", "checks": checks}
