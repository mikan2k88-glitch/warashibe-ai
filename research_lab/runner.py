...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "supabase_schema_dry_run_validation", "next_theme": "supabase_migration_readiness_gate", "checks": checks}
