...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "autonomous_research_orchestrator_execution_layer_bounded_executor_design", "next_theme": "autonomous_research_orchestrator_execution_layer_bounded_executor_policy", "checks": checks}
