...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "autonomous_research_orchestrator_execution_layer_cycle_accounting_validation", "next_theme": "autonomous_research_orchestrator_execution_layer_cycle_accounting_repair", "checks": checks}
