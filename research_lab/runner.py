...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "supabase_client_integration_design", "next_theme": "supabase_schema_dry_run_validation", "checks": checks}
