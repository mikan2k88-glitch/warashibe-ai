...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "autonomous_research_controller_budget_snapshot_gate", "next_theme": "autonomous_research_controller_budget_snapshot_gate_contract", "checks": checks}
