...
def run_cycle():
    modules = [
        ...
        "research_lab.test_multi_provider_decision_pipeline", "research_lab.test_market_snapshot_freshness", "research_lab.test_freshness_gated_multi_provider_decision", "research_lab.test_decision_outcome_learning_bridge", "research_lab.test_closed_loop_market_learning_cycle", "research_lab.test_closed_loop_observability", "research_lab.test_ebay_browse_adapter", "research_lab.test_ebay_browse_transport", "research_lab.test_ebay_browse_response_mapping", "research_lab.test_ebay_browse_ingestion_bridge", "research_lab.test_supabase_runtime_smoke", "research_lab.test_supabase_keepalive_scheduler", "research_lab.test_supabase_schema_contract",
    ]
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "supabase_warashibe_schema_contract", "next_theme": "supabase_schema_migration_plan", "checks": checks}
