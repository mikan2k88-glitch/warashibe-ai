...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "autonomous_research_controller_budget_snapshot_gate_bridge_contract", "next_theme": "autonomous_research_controller_budget_snapshot_gate_bridge_validation", "checks": checks}
