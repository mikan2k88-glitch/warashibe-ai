...
def run_cycle():
    ...
    snapshot = {"generated_at": datetime.now(timezone.utc).isoformat(),
                ...
                "stage": "autonomous_research_orchestrator_milestone_notification_envelope_validation", "next_theme": "autonomous_research_orchestrator_milestone_notification_boundary", "checks": checks}
