...
<body>
    ...
    <ul>
        ...
        <li>
            <a href="/simulate?strategy=balanced&simulations=1000">
                /simulate?strategy=balanced&simulations=1000
            </a>
            ：単体シミュレーション
        </li>
        ...
        <li>
            <a href="/campaign/simulate?strategy=balanced&campaigns=1000&max_cycles=10">
                /campaign/simulate?strategy=balanced&campaigns=1000&max_cycles=10
            </a>
            ：再挑戦ありの統計
        </li>
